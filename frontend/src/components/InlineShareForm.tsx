...
export default function InlineShareForm({
  ...
  // Share type
  const [shareType, setShareType] = useState<"giveaway" | "exchange" | "loan">(
    "giveaway",
  );
